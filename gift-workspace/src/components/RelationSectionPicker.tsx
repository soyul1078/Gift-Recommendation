...
const relationSections: readonly RelationSection[] = [
  ...
  },
  {
    id: "occasion",
    label: "기념일",
    description: "100일, 생일, 1주년 등",
    options: ["가벼운 기념일(100일 등)", "특별한 기념일(생일, 1주년)"],
  },
];
    ...
    <div className="grid gap-2">
      {relationSections.map((section) => {
        ...
        const selectedInSection =
          value != null && section.options.includes(value);
            ...
            >
              <div>
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {selectedInSection && (
                    <span className="rounded-lg bg-zinc-900 px-2 py-0.5 text-xs font-medium text-white">
                      {value}
                    </span>
                  )}
                </div>
